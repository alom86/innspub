...
$copyhtml = <<<EOD
<p style="text-align:center; color:#808000;
        font-family:georgia;
        font-size: 12pt;
        ">IJBB ©<br><span style="color:#808000;">Off Print</span></p>
EOD;
$pdf->writeHTMLCell(25, '', 18, 65, $copyhtml, 0, 1, 0, true, '', true);

$pdf->Image('https://innspub.net/wp-content/uploads/2022/08/innslogo.jpg', '15', '18', 25, 25, 'jpg');

$titlehtml = <<<EOD
<h1 style="text-align:center; color:#0099cc;
        font-family:georgia;
        font-size: 15pt;
...
$pdf->Image('https://innspub.net/wp-content/uploads/2022/08/Off-print_Cover_IJBB-1.jpg', '20', '90', 170, 150, 'jpg');
...
$pdf->Image('https://innspub.net/wp-content/uploads/2022/08/ijbb-2.png', 170, 265, 15, 10, 'png');
