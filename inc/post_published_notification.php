...
function post_published_notification($ID, $post)
{
    ...
    $mail->Host = 'smtp.innspub.net';                        // Specify main and backup SMTP servers
    $mail->SMTPAuth = true;                               // Enable SMTP authentication
    $mail->Username = 'info@innspub.net';                 // SMTP username
    $mail->Password = 'sT%KJchF$1';                       // SMTP password
    ...
    $mail->addBCC('pessinnspub@gmail.com');
    $mail->addBCC('alom8628@gmail.com');
